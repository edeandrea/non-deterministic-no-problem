-- INSERT INTO interactions (interaction_date, interaction_id, application_name, interface_name, method_name, result, system_message, user_message) VALUES ('2026-01-28 08:18:30.299148', 5ae3718e-9412-47da-a31c-87782c250edb, 'non-deterministic', 'org.parasol.ai.ClaimService', 'chat', '"Hi — I’m Parasol Assistant and I can help with Claim ID 1. I see Marty attached photos, a police report, and a repair estimate; please file the claim as soon as possible and note an adjuster may be assigned to inspect the vehicle and assess damages. For immediate assistance you can call 800-CAR-SAFE or email claims@parasol.com, and remember deductibles for collision/comprehensive apply as shown on the declarations page. Would you like help preparing or reviewing any documents before you submit?"', 'You are a helpful, respectful and honest assistant named "Parasol Assistant".
...
--     Question: Hi
-- ');
-- INSERT INTO interaction_scores (score, score_date, interaction_id) VALUES (0.82648784, '2026-01-28 08:18:42.460005', 5ae3718e-9412-47da-a31c-87782c250edb);